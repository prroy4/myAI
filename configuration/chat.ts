...
export const INITIAL_MESSAGE: string = `Hello, I'm ${AI_NAME}, ${OWNER_NAME}'s marketing research AI assistant. Please include a specific research topic/question, type (quantitative vs. qualitative), and objectives for your research along with the task you would like me to perform! I can also chat about best practices in marketing research, refine questions, or simulate focus groups.`;
