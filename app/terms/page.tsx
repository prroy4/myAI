      ...
      <div className="w-full max-w-screen-md space-y-6">
        ...
        <ol className="list-decimal list-inside space-y-4">
          <li className="text-gray-700">
            ...
            accessing and using the AI chatbot ("Chatbot") provided by Prithika
          ...
          <li className="text-gray-700">
            ...
            the fullest extent permitted by applicable law, Prithika shall not be
            ...
            Prithika has been advised of the possibility of such damages.
          </li>
          <li className="text-gray-700">
            <span className="font-semibold">
          ...
          <li className="text-gray-700">
            ...
            decisions made based on its output. Prithika is not responsible for any
          ...
          <li className="text-gray-700">
            ...
            considered equivalent to public postings, and Prithika does not
          ...
          <li className="text-gray-700">
            ...
            indemnify, defend, and hold harmless Prithika from any claims,
